...
class Actor(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Актёры и режтсёры"

class Genre(models.Model):
    #Жанры
    name = models.CharField("Имя", max_length=100)
    descriptiob = models.TextField("Описание")
...
class Rating(models.Model):
    ...
    movie = models.ForeignKey(Movie, on_delete=models.CASCADE, verbose_name="фильмы", related_name="ratings")
